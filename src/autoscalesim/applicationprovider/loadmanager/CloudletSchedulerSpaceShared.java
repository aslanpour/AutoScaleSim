...
//                my code
                getCExecList().removeAll(toRemove);
//                
...
//                                my code
                                getCWaitingList().removeAll(toRemove);
//                                
			}
		}
...
//                        my code
                        getCPausedList().remove(position);
//                        end
