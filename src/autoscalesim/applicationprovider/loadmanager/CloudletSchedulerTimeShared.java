...
import autoscalesim.applicationprovider.loadmanager.CloudletScheduler;
...
public class CloudletSchedulerTimeShared extends CloudletScheduler {
	...
	public double getTotalUtilizationOfCpu(double time) {
		...
		for (ResCloudlet gl : getCloudletExecList()) {// my code (multipe was added)
			totalUtilization += gl.getCloudlet().getUtilizationOfCpu(time) * gl.getCloudlet().getNumberOfPes();
		}
