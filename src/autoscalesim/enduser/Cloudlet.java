...
public class Cloudlet {
	 ...
	 **/
        ...
        private double firstSubmissionTime;
        
        private double failTime;
        private int cloudletId;
        
        public void setCloudletId(final int cloudletId){
            this.cloudletId = cloudletId;
        }
        
        private double responseTime;
        private double delayInFinishing;
	...
	/** The cloudlet ID. */
//	private final int cloudletId; // my code
...
//        my code
	...
	public Cloudlet(
			...
			final UtilizationModel utilizationModelBw,
                        final double firstSubmissionTime) {
		this(
				cloudletId,
				cloudletLength,
				pesNumber,
...
//        end
	...
	public Cloudlet(
		...
		accumulatedBwCost = 0.0;
		costPerBw = 0.0;
                firstSubmissionTime = -1;// my code
                setDelayInFinishing(-1);
                setFailTime(-1);
		requiredFiles = new LinkedList<String>();
	}
	...
	public Cloudlet(
		...
		requiredFiles = new LinkedList<String>();
                ...
                this.failTime = -1;
                this.responseTime = -1;
                // finish time is set to -1 in dwfault
	}
	...
	// ////////////////////// End of Internal Class //////////////////////////
        ...
        public void setFailTime(double time){
            this.failTime = time;
        }
	 ...
	 * @post $none
	 */
	public double getWaitingTime() {// time from the last submission to exec start
		if (index == -1) {
			return 0;
		}
...
//        my code
        /**
         * Gets first submission time
         * @return first submission time
         */
        ...
        /**
         * Sets first submission time
         * @param firstSubmissionTime 
         */
        public void setFirstSubmissionTime( double firstSubmissionTime) {
            this.firstSubmissionTime = firstSubmissionTime;
        }
        ...
        public double getTotalWaitingTime(int cloudletSchedulerName, double vmMips, int vmPEs) {
            if(cloudletSchedulerName == AutoScaleSimTags.TimeShared){
                double processingTime = (cloudletLength * getNumberOfPes()) / (vmMips * vmPEs);
                double waitingtime = finishTime - processingTime - firstSubmissionTime;
//                double waitingtime = finishTime - (cloudletLength / vmMips) - firstSubmissionTime;
                ...
                return waitingtime;
            }else if (cloudletSchedulerName == AutoScaleSimTags.SpaceShared){
                return execStartTime - firstSubmissionTime;
            }else{
                return 0;
            }
        }
        ...
        public double getReminingLenght(double vmMips){// baghimande agar nabod manfi
            double executedLength = ((CloudSim.clock() - getExecStartTime()) * vmMips);
            
            return getCloudletLength() - executedLength;
        }
        
        public void setDelayInFinishing(double delayInFinishing){
            this.delayInFinishing = delayInFinishing;
        }
        
        public double getDelayInFinishing(){
            return delayInFinishing;
        }
//        end
	/**
	 ...
	 * @post $result >= 0.0
	 */
	public double getWallClockTime() { // (resCloudlet) from the latest submission to finish
		if (index == -1) {
			return 0.0;
		}
	 ...
	 * @post $none
	 */
	public double getActualCPUTime() {// (resCloudlet) time from the latest start exec to finish
