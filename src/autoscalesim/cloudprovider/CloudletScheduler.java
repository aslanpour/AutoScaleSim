...
public abstract class CloudletScheduler {
	...
	public CloudletScheduler() {
		setPreviousTime(0.0);
//                my code
                cExecList = new ArrayList<ResCloudlet>();
                cWaitingList = new ArrayList<ResCloudlet>();
                cPausedList = new ArrayList<ResCloudlet>();
//                end
	}
...
// my code
	...
	private List<? extends ResCloudlet> cWaitingList;

	/** The cloudlet exec list. */
	private List<? extends ResCloudlet> cExecList;
        
        /** The cloudlet paused list. */
	private List<? extends ResCloudlet> cPausedList;
        
        public <T extends ResCloudlet> List<T> getCWaitingList() {
		return (List<T>) cWaitingList;
	}
        /**
         * 
         * @param <T>
         * @param cExecList 
         */
        protected <T extends ResCloudlet> void setCWaitingList(List<T> cWaitingList) {
	...
	public <T extends ResCloudlet> List<T> getCExecList() {
		return (List<T>) cExecList;
	}
	 ...
	 * 
	 * @param <T> the generic type
	 * @param cExecList the new cloudlet exec list
	 */
	protected <T extends ResCloudlet> void setCExecList(List<T> cExecList) {
		this.cExecList = cExecList;
	}
	 ...
	 */
	public <T extends ResCloudlet> List<T> getCPausedList() {
		return (List<T>) cPausedList;
	}
	 ...
	 * 
	 * @param <T> the generic type
	 * @param cPausedList the new cloudlet paused list
	 */
	protected <T extends ResCloudlet> void setCPausedList(List<T> cPausedList) {
		this.cPausedList = cPausedList;
	}
//        end
