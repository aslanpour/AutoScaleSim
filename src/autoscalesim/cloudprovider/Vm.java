...
//////////////////////////////////////////////////////////MY CODE //////////////
	...
	public Vm(
		...
		setCurrentAllocatedSize(0);
                ...
                if(purchaseType == AutoScaleSimTags.VM_PURCHASE_ON_DEMAND)
                    price = AutoScaleSimTags.VM_PRICE_ONDEMAND[configurationType];
                else if(purchaseType == AutoScaleSimTags.VM_PURCHASE_RESERVED)
                    price = AutoScaleSimTags.VM_PRICE_RESERVED_1YEAR[configurationType];
                else // Spot
                    price = AutoScaleSimTags.VM_PRICE_SPOT[configurationType];
                
                setBill(price);
                setDestroyTime(-1);
                setLifeTime(0); 
                setDelayInStartUp(delayInStartUp);
                setTier(tier);
                ///////
	}
	...
	public Vm(
        ...
        /**
         * Configuration, t2.micro, t2.small, t2.medium or t2.large
         * @return 
         */
        ...
        /**
         * Purchase, On-Demand, Reserved(1 year, all up front) or Spot
         * @return 
         */
	...
	/**
	 * Get utilization created by all cloudlets running on this VM.
	 * 
	 * @param time the time
